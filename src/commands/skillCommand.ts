...
export class SkillsCommand implements Command {
  ...
  async run(message: Message, args: number[]): Promise<void> {
  ...
  switch (message.content) {
    case 'a!skill 1':
      ...
      .addFields(
        ...
        { name: 'Cooldown', value: skill1.cd > 9 ? skill1.cd : `⏱0${skill1.cd}`, inline: true },
        { name: 'Level Required', value: skill1.levelRequired > 9 ? `⚡ ${skill1.levelRequired}` : `⚡ 0${skill1.levelRequired}`, inline: true },
    ...
    case 'a!skill 2':
      ...
      .addFields(
        ...
        { name: 'Cooldown', value: skill2.cd > 9 ? skill2.cd : `⏱0${skill2.cd}`, inline: true },
        { name: 'Level Required', value: skill2.levelRequired > 9 ? `⚡ ${skill2.levelRequired}` : `⚡ 0${skill2.levelRequired}`, inline: true },
      ...
      .addFields(
        ...
        { name: 'Cooldown', value: skill3.cd > 9 ? `⏱${skill3.cd}` : `⏱0${skill3.cd}`, inline: true },
        { name: 'Level Required', value: skill3.levelRequired > 9 ? `⚡ ${skill3.levelRequired}` : `⚡ 0${skill3.levelRequired}`, inline: true },
